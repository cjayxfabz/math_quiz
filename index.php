...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['start_quiz'])) {
        ...
        $num_items = filter_input(INPUT_POST, 'num_items', FILTER_VALIDATE_INT) ?? 5;
        $max_diff = filter_input(INPUT_POST, 'max_diff', FILTER_VALIDATE_INT) ?? 10;
        $min_range = filter_input(INPUT_POST, 'min_range', FILTER_VALIDATE_INT) ?? 1;
        $max_range = filter_input(INPUT_POST, 'max_range', FILTER_VALIDATE_INT) ?? 10;

        $_SESSION['settings'] = compact('level', 'operator', 'num_items', 'max_diff', 'min_range', 'max_range');
